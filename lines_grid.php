            ...
            <div>
                ...
                <form action="" method="post">
                    <div class="uk-card uk-card-default uk-card-body uk-card-hover uk-position-reletive">
                        <div class="uk-text-small uk-position-top-right uk-background-primary uk-light tm-date" uk-tooltip="title: <?= $title_data ?>; delay: 300">
                            <?= $json_arr[$numId]["data"]; ?>
                        </div>
                        <div class="uk-position-bottom-right uk-padding-small">
                            <a uk-tooltip="title: <?= $title_edit_btn; ?>; delay: 300" class="tm-btns-edit" href="#toggle-animation<?= $numId; ?>" uk-toggle="target: #toggle-animation<?= $numId; ?>; animation: uk-animation-fade" uk-icon="icon: file-edit"></a>
                            <button uk-tooltip="title: <?= $title_delete; ?>; delay: 300" class="tm-btns-del uk-text-danger" uk-icon="icon: trash" type="submit" value="<?= $numId; ?>" name="deleteline"></button>
                        </div>
